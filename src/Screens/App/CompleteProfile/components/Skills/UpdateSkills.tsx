          ...
          <Formik
            ...
            onSubmit={values => {
              ...
              if (title == 'Skills') {
                for (let i = 0; i < selected?.length; i++) {
                  if (CurrentUserData?.user_data?.skills) {
                    for (
                      let i = 0;
                      i < CurrentUserData?.user_data?.skills?.length;
                      i++
                    ) {
                      formdata.append(
                        `skills[${i}]`,
                        CurrentUserData?.user_data?.skills[i].id,
                      );
                    }
                  }
                  formdata.append(`skills[${i}]`, selected[i]);
                }
            ...
            {(props: any) => (
              <View>
                ...
                <View style={{height: appSizes.height * 0.4}} />
