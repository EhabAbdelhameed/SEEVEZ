...
const Form2JobOpportunity = () => {
  ...
  const {data, color}: any = useRoute().params;
  ...
  const [JobTypeName, setJobTypeName] = useState(false);
  const [workTypeName, setWorkTypeName] = useState(false);
...
export default Form2JobOpportunity;
